...
function Hero() {
  return (
    <div className="px-4 2xl:px-[120px] pt-8 md:pt-[120px] w-full flex justify-center flex-col gap-12 md:gap-[90px]">
      ...
      <div className="hero-cards-container flex w-full gap-4 flex-col md:flex-row">
        <HeroCard
          image={graduate}
