        ...
        <div className="flex flex-col md:flex-row justify-between mb-12 gap-8">
          ...
          <div className="text-left">
            ...
            <p className="text-white/80 text-lg max-w-md leading-relaxed">
              İstanbul Sağlık ve Teknoloji Üniversitesi öğrenci ve mezunları
              için kariyer, eğitim ve networking platformu.
            </p>
          </div>
          ...
          <div className="flex space-x-6 h-max">
            <a
              href="#"
              className="bg-white/10 hover:bg-white p-3 rounded-full transition-all duration-300 group"
            >
            ...
            <div className="text-left">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-start">
                  ...
                  <a
                    href="mailto:info@istunetwork.com"
        ...
        <div className="2xl:px-[120px] px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
            ...
            <div className="text-white/60 text-sm">
              İstanbul Sağlık ve Teknoloji Üniversitesi ile bağlantılı bir
              öğrenci platformu
            </div>
          </div>
        </div>
